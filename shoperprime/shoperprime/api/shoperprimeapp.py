...
from shoperho.accounts.doctype.sales_invoice.sales_invoice import get_bank_cash_account
from shoperho.stock.get_item_details import get_item_details
from shoperho.accounts.doctype.pos_profile.pos_profile import get_item_groups
from frappe.utils.background_jobs import enqueue
from shoperho.accounts.party import get_party_bank_account
from shoperho.stock.doctype.batch.batch import (
    get_batch_no,
    get_batch_qty,
    set_batch_nos,
)
from shoperho.accounts.doctype.payment_request.payment_request import (
    get_dummy_message,
    get_existing_payment_request_amount,
)

from shoperho.accounts.doctype.loyalty_program.loyalty_program import (
...
def get_version():
    branch_name = get_app_branch("shoperho")

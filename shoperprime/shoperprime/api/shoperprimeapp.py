...
from frappe.accounts.doctype.sales_invoice.sales_invoice import get_bank_cash_account
from frappe.stock.get_item_details import get_item_details
from frappe.accounts.doctype.pos_profile.pos_profile import get_item_groups
from frappe.utils.background_jobs import enqueue
from frappe.accounts.party import get_party_bank_account
from frappe.stock.doctype.batch.batch import (
    get_batch_no,
    get_batch_qty,
    set_batch_nos,
)
from frappe.accounts.doctype.payment_request.payment_request import (
    get_dummy_message,
    get_existing_payment_request_amount,
)

from frappe.accounts.doctype.loyalty_program.loyalty_program import (
...
def get_version():
    branch_name = get_app_branch("frappe")
